...
- [-] 0. Создать feature branch для разработки
  - [-] 0.1 Создать новую ветку `feature/platform-v2`
  ...
  - [ ] 0.2 Настроить preview deployment (опционально)
...
- [ ] 1. Настройка инфраструктуры и базовых стилей
  - [ ] 1.1 Установить Framer Motion
    - Добавить зависимость: `framer-motion`
    - _Requirements: 1.1, 1.2_
  - [ ] 1.2 Настроить светлую тему и dark mode toggle
  ...
  - [ ] 1.3 Создать переиспользуемые UI компоненты
...
- [ ] 2. Редизайн Hero секции (по образцу Alter)
  - [ ] 2.1 Создать новый Hero компонент
  ...
  - [ ] 2.2 Добавить анимации Hero
    - Fade-in при загрузке страницы
    - Floating элементы с параллаксом при движении мыши
    - _Requirements: 1.1, 2.1_

- [ ] 3. Создать секцию "Интеграции" (по образцу Alter)
  - [ ] 3.1 Добавить логотипы партнёров/интеграций
    - Горизонтальная полоса с логотипами (Telegram, WhatsApp, etc.)
    - Бесконечная анимация прокрутки
    - _Requirements: 1.2_

- [ ] 4. Редизайн Features секции (Bento Grid как в Alter)
  - [ ] 4.1 Создать Bento Grid layout
  ...
  - [ ] 4.2 Добавить анимации карточек
    - Scroll-triggered появление
    - Hover эффекты (scale, glow)
    - _Requirements: 1.2, 1.3, 1.5_

- [ ] 5. Редизайн секции "Как это работает" (6 шагов)
  - [ ] 5.1 Обновить дизайн карточек шагов
    - Нумерация с градиентным фоном
    - Glass-эффект карточек
    - Stagger анимация при скролле
    - _Requirements: 1.2, 1.5_

- [ ] 6. Редизайн Pricing секции (по образцу Alter)
  - [ ] 6.1 Создать новые Pricing карточки
...
- [ ] 7. Добавить FAQ секцию (аккордеон как в Alter)
  - [ ] 7.1 Создать FAQ компонент
    - Создать `src/components/ui/Accordion.tsx`
    - Анимация раскрытия/закрытия
    - _Requirements: 1.3_

- [ ] 8. Добавить Testimonials секцию
  - [ ] 8.1 Создать карусель отзывов
    - Карточки с аватарами и цитатами
    - Автоматическая прокрутка
    - _Requirements: 1.2_

- [ ] 9. Редизайн Footer и CTA секции
  - [ ] 9.1 Обновить финальный CTA блок
    - Градиентный фон
...
- [ ] 10. Обновить Header/Navigation
  - [ ] 10.1 Редизайн навигации
